...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<Apartment?> _getUserNames() async{
      ...
      print(userOne['city']);
      return Apartment(city: await userOne['city'], address: await userOne['address'], apartmentImage: await userOne['apartmentImage'], profileImage: await userOne['profileImage'], savedFavorite: await userOne['savedFavorite'], goingTo: await userOne['goingTo'], userID: await userOne['userID']);
  }

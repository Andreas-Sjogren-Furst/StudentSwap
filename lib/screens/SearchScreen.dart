                  ...
                  children: [
                    ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color:
                              _semesterChips[0] ? Colors.white : Colors.black,
                    ...
                    ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color:
                              _semesterChips[1] ? Colors.white : Colors.black,
                          fontWeight: FontWeight.w600,
                          fontSize: 16.0,
                        ),
                        onSelected: (bool _newValue) {
                    ...
                    ChoiceChip(
                        ...
                        labelStyle: TextStyle(
                          color:
                              _semesterChips[2] ? Colors.white : Colors.black,
                          fontWeight: FontWeight.w600,
                          fontSize: 16.0,
                        ),
                        onSelected: (bool _newValue) {
